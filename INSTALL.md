...
[Releases page](https://github.com/osirisjson/osiris-producers/releases) for Linux,
macOS and Windows. No Go toolchain required.
...
|---------|-------------|--------------------------------------------------|
| Linux   | x86-64      | `osiris-producers_<version>_linux_amd64.tar.gz`  |
| Linux   | ARM 64      | `osiris-producers_<version>_linux_arm64.tar.gz`  |
| macOS   | Intel       | `osiris-producers_<version>_darwin_amd64.tar.gz` |
| macOS   | Apple M1/M2 | `osiris-producers_<version>_darwin_arm64.tar.gz` |
| Windows | x86-64      | `osiris-producers_<version>_windows_amd64.zip`   |

Linux users can also install via the `.deb` or `.rpm` packages listed on the release page.
...
Full documentation: https://osirisjson.org/en/docs/producers/getting-started

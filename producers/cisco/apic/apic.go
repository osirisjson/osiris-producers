// apic.go - Cisco ACI/APIC producer for OSIRIS JSON.
...
type Producer struct {
	target shared.TargetConfig
	cfg    *shared.RunConfig
	client *Client // injectable for testing
}

// NewFactory returns a ProducerFactory for the APIC producer.
func NewFactory() shared.ProducerFactory {
	return func(target shared.TargetConfig, cfg *shared.RunConfig) sdk.Producer {
